    ...
    def eval(
        ...
        *,
        ...
        with logging_redirect_tqdm():
            ...
            # pickle.dump({"index": tuple(ii), "slice": pred}, open(f"/output/{self.get_plane()}/{os.environ['BRAIN_SLICE_INDEX']}_slice_05.pkl", "wb"))
            ...
            for i in range(256):
                ...
                # if i in [7,22,23,40,74,87,91,92,98,103,127,166,167,170,171,234 ]  and self.get_plane() == 'coronal': continue
                # elif i in [23, 33, 46, 54, 55, 56, 111, 179 ]  and self.get_plane() == 'axial': continue
                # elif i in [62,107,112,141,188,208]  and self.get_plane() == 'sagittal': continue
                
                # if i in [155,54,124,148,118]: continue
                
                # a=pickle.load(open(f"/output/{self.get_plane()}/thresh{''.join(os.environ['NANCONV_THRESHOLD'].split('.'))}/{i}_slice.pkl", 'rb'))
